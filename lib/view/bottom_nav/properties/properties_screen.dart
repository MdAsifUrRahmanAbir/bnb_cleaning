...
import '../../../backend/model/my_property/property_list_model.dart' as property;
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    for(var i = 0; i<cart.length; i++){
                      if(data.id.toString() == cart[i].propertyId.toString()){
                    ...
                    return Obx(() => PropertyCard(
                      ...
                      onTapEdit: () {
                        ...
                        updateController.propertyNameController.text =
                            data.identifier;
                        updateController.propertyDescriptionController.text =
                            data.description;
                        updateController.contactNameController.text =
                            data.newContactName;
                        updateController.contactPhoneController.text =
