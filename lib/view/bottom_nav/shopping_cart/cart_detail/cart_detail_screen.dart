        ...
        appBar: PrimaryAppBar(
          ...
          actions: [
            Obx(() => Visibility(
                  ...
                  child: Get.find<ShoppingCartController>().isLoading
                      ? const CustomLoadingAPI()
                      : InkWell(
                          onTap: () {
                            Get.find<ShoppingCartController>()
                                .cartIndexProcess().then((value){
                              Get.to(const StripePaymentScreen(), arguments: id.toString());
                            });
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(
                                horizontal:
                                    Dimensions.paddingSizeHorizontal * 3,
        ...
        body: Obx(() => SafeArea(
              ...
              children: [
                ShoppingCardCardWidget(
                  ...
                  title: title,
                  subTitle: subTitle,
                  price: controller.totalPrice.value == 0
                      ? ""
                      ...
                      children: [
                        Column(
                          children: List.generate(
                              priceController
                                  .priceListModel.airbnbCleanings.length,
                              (index) => Padding(
                              ...
                              child: Visibility(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    for (var i = 0;
                                        i < controller.airbnbArray.length;
                                        i++) {
                                      if (controller.airbnbArray[i] != 0) {
                                        controller.airbnbPrice.add(
                                            priceController.priceListModel
                                                    .airbnbCleanings[i].price *
                                                double.parse(controller
                                                    .airbnbArray[i]
                                                    .toString()));
                                        // controller.airbnbPrice.add(priceController
                                        //     .priceListModel.airbnbCleanings[i].price);
                                        controller.airbnbName.add(
                                            priceController.priceListModel
                                                .airbnbCleanings[i].title);
                                        controller.airbnbQty
                                            .add(controller.airbnbArray[i]);
                                      }
                                    }
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        AddSubtractWidget(
                                          initialValue: 0,
                                          onChanged: (Map value) {
                                            controller.lineHireArray[index] =
                                                value["qty"];

                                            if (value["qty"] > 0) {
                                              controller.lineEnable.value =
                                                  true;
                                            }
                                            if (value["type"] == "add") {
                                              controller.totalPrice.value +=
                                                  priceController.priceListModel
                                                      .linenHires[index].price;
                                            } else {
                                              controller.totalPrice.value -=
                                                  priceController.priceListModel
                                                      .linenHires[index].price;
                        ...
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Visibility(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    debugPrint(controller.lineHirePrice.length
                                        .toString());
                                    debugPrint(controller.lineHireQty.length
                                        .toString());
                                    debugPrint(controller.lineHireName.length
                                        .toString());

                                    if (controller.onlyLineSelected == 0) {
                                      if (controller.totalPrice.value >= 40) {
                                        for (var i = 0;
                                            i < controller.lineHireArray.length;
                                            i++) {
                                          if (controller.lineHireArray[i] !=
                                              0) {
                                            ...
                                            controller.lineHireName.add(
                                                priceController.priceListModel
                                                    .linenHires[i].title);
                                            controller.lineHireQty.add(
                                                controller.lineHireArray[i]);
                                          }
                                        }
                                      ...
                                      for (var i = 0;
                                        ...
                                        if (controller.lineHireArray[i] != 0) {
                                          ...
                                          controller.lineHireName.add(
                                              priceController.priceListModel
                                                  .linenHires[i].title);
                                          controller.lineHireQty
                                              .add(controller.lineHireArray[i]);
                                        }
                                      }
                                      controller.onLineHireSelected(true);
                                    }
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      AddSubtractWidget(
                                        initialValue: 0,
                                        onChanged: (Map value) {
                                          controller.midStayArray[index] =
                                              value["qty"];

                                          if (value["qty"] > 0) {
                                            controller.midStayEnable.value =
                                                true;
                                          }
                                        ...
                                        for (var i = 0;
                                          ...
                                          if (controller.midStayArray[i] != 0) {
                                            ...
                                            controller.midStayName.add(
                                                priceController.priceListModel
                                                    .midCleanings[i].title);
                                            controller.midStayQty.add(
                                                controller.midStayArray[i]);
                                          }
                                        }
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      AddSubtractWidget(
                                        initialValue: 0,
                                        onChanged: (Map value) {
                                          controller.productArray[index] =
                                              value["qty"];
                                          if (value["qty"] > 0) {
                                            controller.proAndBundleEnable
                                                .value = true;
                                          }
                                          if (value["type"] == "add") {
                                            controller.totalPrice.value +=
                            ...
                            child: Visibility(
                              ...
                              child: controller.isUpdateLoading
                                  ...
                                  : InkWell(
                                      onTap: () {
                                        for (var i = 0;
                                            i < controller.productArray.length;
                                            i++) {
                                          if (controller.productArray[i] != 0) {
                                            ...
                                            controller.productAndBundleName.add(
                                                priceController.priceListModel
                                                    .products[i].name);
                                            controller.productAndBundleQty.add(
                                                controller.productArray[i]);
                                          }
                                        }
                                        controller
                                            .productAndBundleUpdateProcess();
                                      },
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:
                                      ...
                                      AddSubtractWidget(
                                        ...
                                        onChanged: (Map value) {
                                          controller.optionalsArray[index] =
                                              value["qty"];
                                          if (value["qty"] > 0) {
                                            controller.optionalsEnable.value =
                                                true;
                                          }
                                          if (value["type"] == "add") {
                                            controller.totalPrice.value +=
                          ...
                          child: Visibility(
                            ...
                            child: controller.isUpdateLoading
                                ...
                                : InkWell(
                                    onTap: () {
                                      for (var i = 0;
                                          i < controller.optionalsArray.length;
                                          i++) {
                                        if (controller.optionalsArray[i] != 0) {
                                          controller.optionalsName.add(
                                              priceController.priceListModel
                                                  .bundles[i].name);
                                          controller.optionalsPrice.add(
                                              double.parse(priceController
                                                      .priceListModel
                                                      .bundles[i]
                                                      .price
                                          ...
                                          controller.optionalsQty.add(
                                              controller.optionalsArray[i]);
                                        }
                                      }
                    ...
                    : InkWell(
                        onTap: () {
                          for (var i = 0;
                              ...
                              i++) {
                            if (controller.optionalsArray[i] != 0) {
                              controller.optionalsName.add(priceController
                                  .priceListModel.bundles[i].name);
                              // controller.optionalsPrice
                              ...
                              controller.optionalsPrice.add(double.parse(
                                  priceController
                                      .priceListModel.bundles[i].price
                                      .toString()));
                              controller.optionalsQty
                                  .add(controller.optionalsArray[i]);
                            }
                          }
                          controller.optionalsUpdateProcess();
                        },
                          ...
                          onTap: () {
                            for (var i = 0;
                              ...
                              if (controller.productArray[i] != 0) {
                                ...
                                controller.productAndBundlePrice.add(
                                    double.parse(priceController
                                        .priceListModel.products[i].price
                                        .toString()));
                                controller.productAndBundleName.add(
                                    priceController
                                        .priceListModel.products[i].name);
                          ...
                          onTap: () {
                            for (var i = 0;
                              ...
                              if (controller.midStayArray[i] != 0) {
                                ...
                                controller.midStayPrice.add(priceController
                                    .priceListModel.midCleanings[i].price);
                                controller.midStayName.add(priceController
                                    .priceListModel.midCleanings[i].title);
                                controller.midStayQty
                                    .add(controller.midStayArray[i]);
                              }
                            }
                            controller.onMidstaySelected(true);
                          },
                        ...
                        if (controller.totalPrice.value >= 40) {
                          for (var i = 0;
                            ...
                            if (controller.lineHireArray[i] != 0) {
                              ...
                              controller.lineHirePrice.add(priceController
                                  .priceListModel.linenHires[i].price);
                              controller.lineHireName.add(priceController
                                  .priceListModel.linenHires[i].title);
                              controller.lineHireQty
                                  .add(controller.lineHireArray[i]);
                            }
                          }
